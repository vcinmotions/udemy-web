...
// Renamed payload inside to prevent conflict with the type 'CourseFormData'
...
export function CreateCourseForm() {
  ...
  // Extracted values safely inside the component context
  const selectedCategoryId = watch('categoryId');
  const thumbnail = watch('image');

  // File Upload Handlers safely integrated inside the component
  ...
  const learnArray = useFieldArray({
    control,
    name: 'whatYouWillLearn',
  });

  const requirementArray = useFieldArray({
    control,
    name: 'requirements',
  });
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-muted-foreground">
              Build a professional learning experience with videos, curriculum, pricing, and course metadata.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-3xl border bg-card p-7 shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    placeholder="Master React, Next.js, TypeScript and Full Stack Development"
                    {...register('subtitle')}
                    className="h-14 w-full rounded-2xl border bg-background px-5 outline-none transition focus:border-black"
                  />
                  {errors.subtitle && (
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <CldUploadWidget
                      ...
                      onSuccess={(result: any) => {
                        setValue('previewVideo', result.info.secure_url);
                      }}
                    >
                      {({ open }) => {
                        return (
            ...
            <div className="rounded-3xl border bg-card p-7 shadow-sm">
              <div className="mb-6 flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold">What Students Will Learn</h2>
                  <p className="text-sm text-muted-foreground">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {categories
                        .find((category: any) => category.id === selectedCategoryId)
