...
export default async function CategoryPage({ params }: Props) {
  ...
  const filteredCourses = courses.filter(
    (course) =>
      course.category.toLowerCase() === formattedSlug ||
      course.subcategory.toLowerCase() === formattedSlug
  );
          ...
          <div className="bg-hero-bg relative z-10 max-w-screen-2xl mx-auto px-4 lg:px-8 py-16 lg:py-20">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-white/70 text-lg leading-relaxed mt-5 max-w-2xl">
                Master modern skills with real-world projects,
                expert-led courses, downloadable resources,
                and production-ready learning paths.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mt-10">
                ...
                {currentCategory && (
                  <div className="bg-white/10 border border-white/10 backdrop-blur-md rounded-2xl px-6 py-5 min-w-[180px]">
                    <p className="text-3xl font-extrabold text-white">
                      {currentCategory.courseCount.toLocaleString()}+
                    </p>
          ...
          {filteredCourses.length === 0 ? (
            <div className="border border-dashed border-border rounded-3xl p-20 text-center bg-card">
              ...
              <p className="text-muted-foreground max-w-md mx-auto">
                We couldn't find courses in this category yet.
                Try exploring another topic.
              </p>
            </div>
          ) : (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-6 flex gap-3">
                      <Link
                        href={`/courses/${courseSlug(course.title)}`}
